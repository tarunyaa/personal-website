...
const NOTES = [
  ...
  {
    date: "2026-06-23",
    title: "The telecom buildout, and who holds the bag",
    body: `The telecom fiber buildout and the dot-com bubble peaked together, roughly 1996 to 2001. It came after Mosaic (1993) and Netscape (1995 IPO) had turned the web into a real thing, so web traffic was genuinely taking off. The trigger was the Telecommunications Act of 1996, which deregulated the industry; carriers like WorldCom, Global Crossing, Qwest, and Level 3 raced to lay long-haul fiber on the thesis that internet traffic would double every 100 days (a WorldCom line that turned out wildly overstated).<br><br>Why so much dark fiber? The glass itself is cheap; the expensive part is the right-of-way and the digging. So once you're already trenching, it's rational to lay far more strands than you need and leave most of them unlit for later. Combined with insane demand forecasts, they massively overbuilt: roughly $500B spent, and by 2002 only about 2 to 5% of installed fiber was actually lit.<br><br>It was tangled with dot-com both ways: dot-coms needed bandwidth, and the equipment makers (Cisco, Nortel, Lucent, JDS Uniphase) became bubble darlings themselves; Cisco was briefly the most valuable company in the world in March 2000. When it popped, it popped together: WorldCom and Global Crossing went bankrupt in 2002, and the vendors lost 80 to 95% of their value.<br><br>The part I keep thinking about: value did accrue at the infrastructure, just not to the people who built it. The overbuilt fiber became the cheap backbone Google, Netflix, and AWS ran the 2010s internet on. But the original investors paid too much, too early, with too much debt, so they got wiped out and the asset changed hands cheaply in bankruptcy. The application layer harvested the surplus. Infra can be a great asset and a terrible investment at the same time, depending on what you paid and when. Same pattern as railroads and canals, and maybe AI data centers now.`,
  },
  {
    date: "2026-06-22",
    title: "Money is mostly debt",
    body: `In most developed economies, roughly 97% of the money supply is created digitally by private banks, as debt. When a bank issues a loan, it just types numbers into a computer and new money appears. Physical cash from the government or central bank is only about 3 to 8% of the total.<br><br>How it compounds: under fractional reserve rules, a bank historically had to keep only a fraction of a deposit, say 10%, and could lend out the other 90%. The borrowed $90 gets deposited in another bank, which keeps 10% and lends $81, and so on. So my $100 deposit eventually supports around $1,000 circulating in the economy, the multiplier effect.<br><br>That cascade is why almost all money is created as debt: governments effectively outsourced money creation to private banks, which can create more deposits than actually exist, on the promise to repay. A consequence is that the system needs more debt to produce more growth.<br><br>I think the original purpose was to fuel economic growth and to prevent bank runs.`,
  },
  {
    date: "2026-06-21",
